        ...
        {items.map((n) => {
          ...
          return (
            <Link
              ...
              className={`relative -mb-px inline-flex shrink-0 items-center gap-2 whitespace-nowrap border-b-2 pl-0 pr-5 py-3.5 mr-6 last:mr-0 text-[14px] tracking-[-0.005em] transition ${
                isActive
