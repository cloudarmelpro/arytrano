...
export function HeaderPrimaryNav({ items }: { items: NavEntry[] }) {
  ...
  return (
    ...
    >
      <div className="no-scrollbar mx-auto flex max-w-[1280px] items-stretch gap-2 overflow-x-auto px-6 lg:px-10">
        {items.map((n) => {
          ...
          return (
            <Link
              ...
              className={`relative -mb-px inline-flex shrink-0 items-center gap-2 whitespace-nowrap border-b-2 pl-0 pr-3 py-3.5 mr-3 last:mr-0 text-[14px] tracking-[-0.005em] transition ${
                isActive
