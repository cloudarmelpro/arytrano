...
export const mg: Record<MessageKey, string> = {
  ...
  'onboarding.owner.terms.highlight.title':
    'Raha manofa ivelan’ny AryTrano nefa tsy mampandre : sazy indray mandeha 10 % amin’ny hofa iray volana',
  'onboarding.owner.terms.highlight.body':
    'Raha misy trano voapanantra amin’ny AryTrano nefa nofananao tamin’ny mpanofa hitanao ivelany, ary tsy nampandre anay ianao tao anatin’ny 48 ora (avy amin’ny dashboard-nao na amin’ny WhatsApp AryTrano), dia mandoa onitra indray mandeha mitovy amin’ny 10 %-n’ny hofan-trano isam-bolana ianao. Fandoavana indray mandeha — tsy mamerina isam-bolana — mba hiarovana ny rariny eo amin’ireo tompon-trano marina sy ireo hafa.',
  ...
  'admin.nav.refunds': 'Famerenam-bola',
  ...
  'admin.quiz.page.lead':
    'Fizarana ny valin-teny + faritra ambony notolorana. Manampy amin\'ny fitarihana ny atiny marketing sy ny fanitsiana ny profile-n\'ny faritra.',
  'admin.quiz.kpi.total': 'Valim-pamantarana totaly',
  'admin.quiz.kpi.last7Days': '7 andro lasa',
  'admin.quiz.kpi.last30Days': '30 andro lasa',
  'admin.quiz.kpi.emailRate': 'Tahan\'ny email opt-in',
  'admin.quiz.kpi.emailRate.help':
    '{with} misy email · {without} tsy misy',
  'admin.quiz.section.locale': 'Fizarana araka ny fiteny',
  'admin.quiz.section.topQuartiers': 'Faritra ambony notolorana',
  'admin.quiz.section.topQuartiers.help':
    'Manisa hoatrinona ny isan\'ny fivoahan\'ny faritra ao amin\'ny top-3 notolorana.',
  'admin.quiz.section.answers': 'Fizarana ny valin-teny',
  'admin.quiz.empty': 'Mbola tsy misy valim-pamantarana — zarao ny rohy /quartiers/quiz.',
  'admin.quiz.question.budget': 'Tetibola isam-bolana',
  'admin.quiz.question.school': 'Sekoly arahina',
  'admin.quiz.question.housingType': 'Karazana trano',
  'admin.quiz.question.vibe': 'Toetra tadiavina',
  'admin.quiz.question.mobility': 'Fihetsiketsehana tiana',
  'admin.quiz.question.priority': 'Laharam-pahamehana',
  ...
  'admin.quiz.answer.school.university': 'Anjerimanontolo',
  'admin.quiz.answer.school.lycee': 'Lise',
  'admin.quiz.answer.school.unsure': 'Tsy azoko antoka',
  'admin.quiz.answer.housingType.ROOM': 'Efitra',
  'admin.quiz.answer.housingType.STUDIO': 'Studio',
  'admin.quiz.answer.housingType.APARTMENT': 'Appartement',
  'admin.quiz.answer.housingType.any': 'Tsy maninona',
  'admin.quiz.answer.vibe.calm': 'Mangina',
  'admin.quiz.answer.vibe.lively': 'Mavitrika',
  'admin.quiz.answer.vibe.mixed': 'Mifangaro',
  'admin.quiz.answer.mobility.walk': 'An-tongotra',
  'admin.quiz.answer.mobility.taxibe': 'Taxi-be',
  'admin.quiz.answer.mobility.car': 'Fiara',
  'admin.quiz.answer.priority.price': 'Vidiny',
  'admin.quiz.answer.priority.school': 'Sekoly',
  'admin.quiz.answer.priority.calm': 'Filaminana',
  'admin.quiz.answer.priority.social': 'Fiarahamonina',
