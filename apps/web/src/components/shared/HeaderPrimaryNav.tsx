        ...
        {items.map((n) => {
          ...
          return (
            <Link
              ...
              className={`relative -mb-px inline-flex shrink-0 items-center justify-center min-w-[44px] sm:min-w-0 gap-1 sm:gap-2 whitespace-nowrap border-b-2 px-2 sm:pl-0 sm:pr-2.5 py-3.5 mr-0.5 sm:mr-2.5 last:mr-0 text-[12px] sm:text-[13px] tracking-[-0.005em] transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-primary ${
                isActive
