      ...
      <div className="mx-auto max-w-[1280px] px-6 lg:px-10">
        <div className="mx-auto max-w-[800px] text-center">
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-3">
            <Link
              href="/quartiers/quiz"
              className="inline-flex h-12 items-center rounded-xl bg-primary px-6 text-[15px] text-primary-foreground shadow-sm transition hover:opacity-95"
            >
              {t('quartiers.cta.primary')} <span aria-hidden className="ml-2">→</span>
            </Link>
            <Link
              href="/annonces"
              className="inline-flex h-12 items-center rounded-xl border border-border bg-background px-6 text-[15px] text-foreground transition hover:bg-muted"
            >
